...
prototypes = [
    ...
    Prototype(
        regex=re.compile(r'^sha1\$[a-z0-9\/\.]{1,12}\$[a-f0-9]{40}$', re.IGNORECASE),
        modes=[
    ...
    Prototype(
        regex=re.compile(r'^sha256\$[a-z0-9\/\.]{1,12}\$[a-f0-9]{64}$', re.IGNORECASE),
        modes=[
            HashMode(name='Django CMS(SHA-256)', hashcat=None, extended=False)]),
    Prototype(
        regex=re.compile(r'^sha384\$[a-z0-9\/\.]{1,12}\$[a-f0-9]{96}$', re.IGNORECASE),
        modes=[
